...
RupeeTracker is a comprehensive, user-specific personal finance application built using **Java Swing**. It allows individual users to securely track expenses, manage dual balances (Online/Offline), set monthly goals, and analyze their spending trends through interactive graphical charts.
...
The entire application is organized into the following files within the `RupeeTracker` package:
```
RupeeTracker/
├── RupeeTrackerJava.java   
├── AuthFrame.java         
├── AuthPanel.java         
├── User.java             
├── Expense.java
...
* **Developer:** Rudra Gupta
* **Contact:** 23rudragupta@gmail.com
...
Navigate to the directory *containing* the `RupeeTracker` folder and compile all Java source files:

javac RupeeTracker/*.java

### 2. Execution

Run the main application class:

java RupeeTracker.RupeeTrackerJava
