...
public class RupeeTracker extends JFrame {

    private final String CURRENCY_SYMBOL = "₹"; 
    
    private Map<String, User> userDatabase = new HashMap<>();
    private User currentUser; 
    private final String FILE_NAME = "RupeeTracker_users.dat";
    ...
    public RupeeTracker() {
        ...
        setTitle("RupeeTracker - Java Edition"); 
        setSize(1000, 700); 
    ...
    private void initializeUserUI() {
        setTitle("RupeeTracker (Logged in as: " + currentUser.getUsername() + ")");
    ...
    private JPanel createFeedbackPanel() {
        ...
        JLabel devName = new JLabel("--Rudra Gupta--"); 
        ...
        JLabel contactEmail = new JLabel("23rudragupta@gmail.com"); 
    ...
    public static void saveUserData(Map<String, User> userDB) { 
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("RupeeTracker_users.dat"))) {
    ...
    public static void main(String[] args) {
        ...
        File f = new File("RupeeTracker_users.dat");
        ...
        if (authFrame.isAuthenticated()) {
            ...
            EventQueue.invokeLater(() -> {
                try {
                    RupeeTracker app = new RupeeTracker();
